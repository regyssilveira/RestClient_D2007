...
begin
  Result := FClient.ExecuteRequest(Self, AMethod);
end;
...
function TRestRequest.GetHeaders: TStrings;
begin
  Result := FHeaders;
end;

function TRestRequest.GetParams: TStrings;
begin
  Result := FParams;
end;

function TRestRequest.GetBody: string;
begin
  Result := FBody;
end;

function TRestRequest.GetBodyContentType: string;
begin
  Result := FBodyContentType;
end;

function TRestRequest.GetParts: TList;
begin
  Result := FParts;
end;
